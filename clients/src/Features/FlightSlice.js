...
export const addFlight = createAsyncThunk(
  ...
  async (flightData, { rejectWithValue }) => {
    try {
      const response = await axios.post("https://servers-ygch.onrender.com/addFlight", flightData);
...
export const deleteFlight = createAsyncThunk(
  ...
  async (flightId, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.delete(`https://servers-ygch.onrender.com/flights/${flightId}`);
...
export const updateFlight = createAsyncThunk(
  ...
  async ({ flightId, destination, date, time, price, airline }, { rejectWithValue }) => {
    try {
      const response = await axios.put(`https://servers-ygch.onrender.com/updateFlight/${flightId}`, {
        destination,
        date,
        time,
        price,
...
export const getFlights = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get('https://servers-ygch.onrender.com/api/flights');
